        ...
        <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div class="space-y-12">
            <section class="text-center">
              ...
              <p class="mt-4 text-xl text-gray-600 max-w-2xl mx-auto font-sans font-medium">
            ...
            <section class="bg-white rounded-xl shadow-sm p-8">
              <h2 class="text-2xl font-semibold text-gray-900 mb-6 font-display">About Me</h2>
              <div class="prose prose-lg max-w-none text-gray-600 font-sans">
                <p class="font-normal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                  <div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-3 font-display">Expertise</h3>
                  ...
                  <div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-3 font-display">Focus Areas</h3>
                    <ul class="list-disc list-inside space-y-2 font-normal">
